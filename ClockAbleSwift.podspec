...
s.homepage         = "https://github.com/KyleWhale/ClockAbleSwift.git"

s.license          = 'MIT'
s.author           = { "Eliyar Eziz" => "eliyar917@gmail.com" }
s.source           = { :git => "https://github.com/KyleWhale/ClockAbleSwift.git", :tag => s.version.to_s }
